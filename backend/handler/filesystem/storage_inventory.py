...
def _read(
    ...
    return InventoryRow(
        ...
        "handler.filesystem.storage_access:authorize_external_access",
        evidence,
    )
...
INVENTORY: tuple[InventoryRow, ...] = (
    _read(
        ...
        "get_legacy_external_storage_descriptor",
        ("RESOLVE",),
        Evidence(
            "tests/handler/filesystem/test_external_read_consumers.py",
    ...
    _mutation(
        ...
        ("WRITE",),
        InventoryDisposition.POLICY_GOVERNED,
        "endpoints.storage_policy:authorize_external_mutation",
        _ENDPOINT_EVIDENCE,
    ),
    _mutation(
        "endpoint-mutation",
    ...
    _mutation(
        ...
        ("READ", "CREATE", "DELETE"),
        InventoryDisposition.POLICY_GOVERNED,
        "handler.filesystem.storage_access:OwnedCreateCapability",
        Evidence(
    ...
    _mutation(
        ...
        ("DOWNLOAD", "REPLACE"),
        InventoryDisposition.POLICY_GOVERNED,
        "handler.filesystem.storage_access:OwnedReplaceCapability",
        Evidence(
    ...
    _mutation(
        ...
        ("READ", "REPLACE", "DELETE"),
        InventoryDisposition.OWNED_ONLY,
        "handler.filesystem.storage_access:authorize_owned_access",
        Evidence(
    ...
    _mutation(
        ...
        ("MKDIR",),
        InventoryDisposition.POLICY_GOVERNED,
        "handler.filesystem.storage_policy:authorize_storage_operation",
        _ENDPOINT_EVIDENCE,
    ),
    _mutation(
        "cleanup",
    ...
    _mutation(
        ...
        ("JOB",),
        InventoryDisposition.OWNED_ONLY,
        "handler.filesystem.storage_policy:StoragePolicyDenied",
        Evidence(
            "tests/tasks/test_storage_policy.py",
