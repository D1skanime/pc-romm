...
| `tauri`                 | `2.9.5`       | crates.io, `tauri-apps/tauri`                   | MIT OR Apache-2.0 | No RustSec advisory listed | Typed native shell and constrained webview IPC boundary.                            |
| `tauri-build`           | `2.5.1`       | crates.io, `tauri-apps/tauri`                   | MIT OR Apache-2.0 | No RustSec advisory listed | Generates the checked Tauri configuration at build time.                            |
| `tauri-plugin-dialog`   | `2.4.0`       | crates.io, `tauri-apps/plugins-workspace`       | MIT OR Apache-2.0 | No RustSec advisory listed | Native-only destination folder chooser.                                             |
