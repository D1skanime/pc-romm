...
| 03-06-T1           | MAP-03, MAP-06, API-03, TEST-02                 | T-03-FALLBACK, T-03-UNBOUNDED                       | Preview is bounded and non-mutating; missing mapping is a typed conflict and never a legacy fallback or empty success                                                   | endpoint/integration    | `cd backend && uv run pytest tests/endpoints/test_storage.py -k preview -x`                                                                                             | Planned in 03-06           | planned |
